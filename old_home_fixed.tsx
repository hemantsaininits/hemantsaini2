                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        <div className="text-center lg:text-left">
                            ...
                            <p className="hero-subtitle text-lg lg:text-xl text-white/60 leading-relaxed max-w-xl mb-10 opacity-0 mx-auto lg:mx-0">
                                Businesses pouring time and money into technology that looked impressive on the surface but quietly failed where it actually matteredΓÇö<span className="text-white">adoption, operations, trust.</span>
                            </p>
                    ...
                    <div className="space-y-6 text-lg text-white/60 leading-relaxed">
                        ...
                        <div className="pt-6 shaped-reveal opacity-0">
                            <p className="text-xl text-white font-medium">
                                What all of these taught me: Good systems aren't built by chasing trendsΓÇöthey're built by understanding reality.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="think-reveal opacity-0">
                            <div className="flex items-start gap-4">
                                <Minus className="w-6 h-6 text-orange-500 mt-1 flex-shrink-0" />
                                <p className="text-lg text-white/70 leading-relaxed">
                                    My approach blends <span className="text-white">technical judgment with market awareness</span>ΓÇöbecause a product that can't be adopted, sold, or operated is just a well-designed liability.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-16 pt-10 border-t border-white/10">
                        ...
                        <p className="text-xl text-white/80 leading-relaxed think-reveal opacity-0">
                            I usually work as a <span className="text-white">tech advisor, product thinker, and go-to-market partner</span>ΓÇönot just someone who executes instructions. That means I'm involved in shaping direction, not just delivering outputs.
                        </p>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="card-dark p-8 lg:p-10 partner-reveal opacity-0">
                        <p className="text-xl text-white/80 leading-relaxed">
                            If something doesn't create <span className="text-orange-500">trust</span>ΓÇöfor users, for teams, for the businessΓÇöI don't consider it finished.
                        </p>
                    </div>
                </div>
            </section>
