...
const BusinessStrategicMoves = () => {
    const moves = [
            ...
            content: (
                <>
                    ...
                    <div className="bg-white/5 p-4 rounded-lg mb-4">
                        <h4 className="font-semibold text-orange-400 mb-2">The Shift:</h4>
            ...
            content: (
                <>
                    ...
                    <div className="bg-white/5 p-4 rounded-lg mb-4">
                        ...
                        <p className="text-sm text-white/70">If you sell web design, partner with SEO agencies. They refer you, you refer them.</p>
                    </div>
                </>
            )
        },
        {
            ...
            content: (
                <>
                    ...
                    <div className="bg-white/5 p-4 rounded-lg mb-4">
                        <h4 className="font-semibold text-orange-400 mb-2">Ideas:</h4>
                        <ul className="list-disc pl-5 space-y-1 text-sm text-white/70">
        ...
        {
            icon: <Gem className="text-orange-500" size={32} />,
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <div className="bg-white/5 p-4 rounded-lg mb-4">
                        <h4 className="font-semibold text-orange-400 mb-2">Use Cases:</h4>
                        <ul className="list-disc pl-5 space-y-1 text-sm text-white/70">
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <div className="bg-white/5 p-4 rounded-lg mb-4">
                        <h4 className="font-semibold text-orange-400 mb-2">Core Values:</h4>
                        <p className="text-sm text-white/70">Define 3-5 non-negotiable behaviors (e.g., "Radical Transparency", "Speed Matters").</p>
                    </div>
                </>
            )
        },
        {
            icon: <Smile className="text-orange-500" size={32} />,
        ...
        {
            icon: <Flag className="text-orange-500" size={32} />,
            ...
            content: (
                <>
                    ...
                    <div className="bg-white/5 p-4 rounded-lg mb-4">
                        <h4 className="font-semibold text-orange-400 mb-2">The Value Test:</h4>
                        <p className="text-sm text-white/70">If you left for a year, would the business grow, shrink, or die?</p>
                    </div>
                </>
            )
        }
        ...
        <div className="relative bg-[#0a0a0c] text-white min-h-screen font-sans selection:bg-orange-500/30">
            ...
            <div className="pt-28 sm:pt-32 pb-12 px-4 sm:px-6 lg:px-12 max-w-5xl mx-auto">
                ...
                <div className="mt-20 bg-gradient-to-br from-orange-900/40 to-black border border-orange-500/30 rounded-3xl p-8 md:p-12 text-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-6">The Infinite Game</h3>
