                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                    {industryInsights.map((insight) => (
                        <Link
                            ...
                            className="group bg-white/5 border border-white/5 hover:border-white/10 p-8 rounded-2xl transition-all hover:bg-white/[0.07] flex flex-col"
                        >
                            <h2 className="text-xl font-medium mb-3 group-hover:text-orange-400 transition-colors">
                                {insight.title}
                            </h2>
                            <p className="text-white/60 text-sm leading-relaxed mb-8 flex-grow">
                                {insight.description}
                            </p>
                            <div className="flex items-center gap-2 text-sm text-white/40 group-hover:text-white transition-colors mt-auto">
