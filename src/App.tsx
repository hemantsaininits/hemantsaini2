    ...
    <div className="relative bg-[#0a0a0c] text-white min-h-screen">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 lg:px-12 py-5 flex items-center justify-between bg-[#0a0a0c]/80 backdrop-blur-md border-b border-white/5">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button onClick={() => scrollToSection(contactRef)} className="text-sm text-white/50 hover:text-white transition-colors">Contact</button>
        </div>
        <button onClick={() => scrollToSection(contactRef)} className="btn-primary text-sm">
          Book a call
        </button>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <div className="hero-cta flex flex-wrap gap-4 opacity-0">
                ...
                <button onClick={() => scrollToSection(shapedRef)} className="btn-outline">
                  Read more
                </button>
              </div>
            </div>
